...
export const metadata = {
  title: 'Enterprise AI Stack & Infrastructure Technology | Formiqa',
  description: 'Explore Formiqa’s enterprise AI technology stack: LLM multi-agent gateways, hybrid vector search RAG, sub-350ms voice AI, zero-hallucination guardrails, and native API connectors.',
};
